...
class Event(Base):
    ...
    side = Column(String, nullable=False, default="offense")  # offense | defense (scouted team's side)
    ...
    # Defensive attributes (used when side == 'defense')
    defensive_front = Column(String)
